module "wrapper" {
  ...
  assume_role_pod_identity                                        = try(each.value.assume_role_pod_identity, var.defaults.assume_role_pod_identity, false)
  ...
  pod_identities                                                  = try(each.value.pod_identities, var.defaults.pod_identities, {})
