module "wrapper" {
  ...
  load_balancer_controller_aga_policy_description                 = try(each.value.load_balancer_controller_aga_policy_description, var.defaults.load_balancer_controller_aga_policy_description, null)
  load_balancer_controller_aga_policy_name                        = try(each.value.load_balancer_controller_aga_policy_name, var.defaults.load_balancer_controller_aga_policy_name, null)
  ...
  override_trust_policy_documents                                 = try(each.value.override_trust_policy_documents, var.defaults.override_trust_policy_documents, [])
  ...
  source_trust_policy_documents                                   = try(each.value.source_trust_policy_documents, var.defaults.source_trust_policy_documents, [])
