...
| [aws_iam_role_policy_attachment.adot_cloudwatch_policy_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.adot_prometheus_policy_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
| [aws_iam_role_policy_attachment.adot_xray_policy_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_attach_cloudwatch_agent_policy_adot"></a> [attach\_cloudwatch\_agent\_policy\_adot](#input\_attach\_cloudwatch\_agent\_policy\_adot) | Determines whether to attach the CloudWatch Agent Server IAM policy to the ADOT role | `bool` | `false` | no |
...
| <a name="input_attach_prometheus_policy_adot"></a> [attach\_prometheus\_policy\_adot](#input\_attach\_prometheus\_policy\_adot) | Determines whether to attach the Prometheus Remote Write policy to the ADOT role | `bool` | `false` | no |
...
| <a name="input_attach_xray_policy_adot"></a> [attach\_xray\_policy\_adot](#input\_attach\_xray\_policy\_adot) | Determines whether to attach the XRay write-only policy to the ADOT role | `bool` | `false` | no |
