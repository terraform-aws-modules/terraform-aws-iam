...
| Name | Type |
|------|------|
| [aws_iam_policy.amazon_cloudwatch_observability](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_policy_document.amazon_cloudwatch_observability](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_amazon_cloudwatch_observability_enable_ebs_volume_ids"></a> [amazon\_cloudwatch\_observability\_enable\_ebs\_volume\_ids](#input\_amazon\_cloudwatch\_observability\_enable\_ebs\_volume\_ids) | Determines whether to enable the collection of EBS volume IDs for Amazon CloudWatch Observability policy | `bool` | `false` | no |
...
| <a name="input_attach_amazon_cloudwatch_observability_policy"></a> [attach\_amazon\_cloudwatch\_observability\_policy](#input\_attach\_amazon\_cloudwatch\_observability\_policy) | Determines whether to attach the Amazon CloudWatch Observability IAM policies to the role | `bool` | `false` | no |
