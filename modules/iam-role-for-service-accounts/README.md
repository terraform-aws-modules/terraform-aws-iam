...
| <a name="input_load_balancer_controller_aga_policy_description"></a> [load\_balancer\_controller\_aga\_policy\_description](#input\_load\_balancer\_controller\_aga\_policy\_description) | Description to use on the Load Balancer Controller AGA IAM policy created | `string` | `null` | no |
| <a name="input_load_balancer_controller_aga_policy_name"></a> [load\_balancer\_controller\_aga\_policy\_name](#input\_load\_balancer\_controller\_aga\_policy\_name) | Name to use on the Load Balancer Controller AGA IAM policy created | `string` | `null` | no |
